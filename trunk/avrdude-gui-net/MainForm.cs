...
namespace avrdudegui
{
    ...
    public partial class MainForm
    {
        ...
        public string avrdude = Environment.CurrentDirectory;
        ...
        public MainForm()
        {
            ...
            {
                mic = mic.Remove(0, 7);
                izbira_cipa.Items.Clear();
                izbira_cipa.Items.Add(mic);
                izbira_cipa.SelectedIndex = izbira_cipa.Items.IndexOf(mic);
                izbira_cipa.Enabled = false;
                textBox3.Clear();
        ...
        {
            string[] cip = izbira_cipa.SelectedItem.ToString().Split(' ');

            string izhod = zagon(@"-p " + cip[0] + " -s -q -e -U flash:w:" + "\"" + pot + "\"" + ":a");
        ...
        private string zagon(string vukaz)
        {
            ...
            try
            {
                ...
                run.Close();
                textBox3.Clear();
                textBox3.AppendText("-c usbasp " + vukaz);
        ...
        void povezava_gumb_Click(object sender, System.EventArgs e)
        {
            ...
            {
                string[] cip = izbira_cipa.SelectedItem.ToString().Split(' ');
                string izhod = zagon(@"-p " + cip[0] + " -s -q");
        ...
        void preberi_varovalke_Click(object sender, System.EventArgs e)
        {
            ...
            string izhod = zagon(@"-p " + cip[0] + " -v -q");
        ...
        {
            string[] cip = izbira_cipa.SelectedItem.ToString().Split(' ');
            string izhod = zagon(@"-p " + cip[0] + " -s -q -e -u -U hfuse:w:0x" + hfuse_vrstica.Text + ":m -U lfuse:w:0x" + lfuse_vrstica.Text + ":m");
        }
    }
}
