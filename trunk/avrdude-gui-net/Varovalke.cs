...
namespace avrdudegui
{
    public partial class Varovalke:Form
    {
        ...
        private void zapiši_varovalke_Click(object sender, EventArgs e)
        {
            ...
            {
                Pripomoèki.Zagon(@"-c " + Vrednosti.Programator + " -p " + cip[0] + " -P " + Vrednosti.Port + " -s -q -e -u -U hfuse:w:0x" + hfuse_vrstica.Text + ":m -U lfuse:w:0x" + lfuse_vrstica.Text + ":m");
            }
        }
        ...
        void preberi_varovalke_Click(object sender, System.EventArgs e)
        {
            ...
            string izhod = Pripomoèki.Zagon(@"-c " + Vrednosti.Programator + " -p " + cip[0] + " -P " + Vrednosti.Port + " -q -U lock:r:lock:h -U lfuse:r:lfuse:h -U hfuse:r:hfuse:h -U efuse:r:efuse:h");
